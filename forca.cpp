...
// Bibliotecas
// Algumas desnecessarias na verdade
...
/* Rápida explicação para int e void:
          ...
          para que a função seja finalizada corretamente. ex.:
   ...
   Rápida explicação para Comandos Incomuns Usados no Jogo:
         ...
         -kbhit();         Key board hit, acontece quando uma tecla é pressionada . 
         -system("pause"); Pausa o programa até que alguma tecla seja pressionada.          
         -isalpha();       Verifica se a varialvel contem só letras.
         -isdigit();       Verifica se a varialvel contem só numeros.
...
{     
     ...
     printf("\n\n\n\n\t\t\t      [__________] \n");
     sleep(200);// Espera 200 Milésimos de Segundo
     system("cls");
     printf("\n\n\n\n\t\t\t      [__________] \n");
     printf("\n\t\t\t       Loading...");
     sleep(200);
